										...
										<section aria-labelledby="information-heading" class="mt-2">
											...
											<div class="mt-6">
												...
												<div class="flex items-center">
													...
													<a href="#"
														class="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">{{ product.reviewCount }}
														reviews</a>
												</div>
											</div>
										</section>
													...
													<RadioGroup v-model="selectedSize" class="mt-4">
														...
														<div class="grid grid-cols-4 gap-4">
															<RadioGroupOption as="template"
																...
																<div
																	:class="[size.inStock ? 'bg-white shadow-sm text-gray-900 cursor-pointer' : 'bg-gray-50 text-gray-200 cursor-not-allowed', active ? 'ring-2 ring-indigo-500' : '', 'group relative border rounded-md py-3 px-4 flex items-center justify-center text-sm font-medium uppercase hover:bg-gray-50 focus:outline-none sm:flex-1']">
